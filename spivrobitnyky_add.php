...
<?php 
    ...
    $query = "SELECT id_kafedry, nazva_kafedry FROM kafedry ORDER BY nazva_kafedry";
    $result_k = mysqli_query($bd_konferentsii, $query);
    ...
    if ( (isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
        ...
        $query = "INSERT INTO `spivrobitnuky` (`id_kafedry`, `prizvyshche`, `imya`, `pobatkovi`) VALUES ('$id_kafedry', '$prizvyshche', '$imya', '$pobatkovi')";
                ...
                <form method="post" name="from1"> 
                    <div class="form-group"> 
                        ...
                        <datalist id="id"> 
                            ...
                            ?>
                            <option value="<?php echo $row["id_kafedry"]; ?>"><?php echo $row["nazva_kafedry"]; ?></option>
                            <?php 
                                } 
                            ?>
                        </datalist>
                    ...
                    <div class="form-group"> 
                        ...
                        <input type="text" class="form-control" name="prizvyshche" placeholder="Ведіть прізвище">
                    </div>
                    <div class="form-group"> 
                        <label for="imya">Ім'я</label>
                        <input type="text" class="form-control" name="imya" placeholder="Ведіть ім'я">
                    </div>
                    <div class="form-group"> 
                        <label for="pobatkovi">По батькові</label>
                        <input type="text" class="form-control" name="pobatkovi" placeholder="Ведіть по батькові">
                    </div>
