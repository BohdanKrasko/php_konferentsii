...
<?php 
    ...
    if (!isset($_POST["MM_insert"])) {
        ...
        $query = "SELECT id_kafedry, nazva_kafedry, roztashuvannya FROM kafedry WHERE id_kafedry = $id_kafedry";
    ...
    if ( (isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
        ...
        $query = "UPDATE `kafedry` SET `nazva_kafedry` = '$nazva_kafedry', `roztashuvannya` = '$roztashuvannya' WHERE `id_kafedry` = '$id_kafedry'";
        $result = mysqli_query($bd_konferentsii, $query);
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-center mx-auto"> 
                ...
                <form method="post" name="from1"> 
                    <div class="form-group"> 
                        ...
                        <input type="text" class="form-control" name="nazva_kafedry" placeholder="Ведіть назву кафедри" value="<?php  echo $row['nazva_kafedry']; ?>">
                    </div>
                    <div class="form-group"> 
                        <label for="nazva_kafedry">Розташування</label>
                        <input type="text" class="form-control" name="roztashuvannya" placeholder="Ведіть розташування кафедри" value="<?php  echo $row['roztashuvannya']; ?>">
                    </div>
                    <input type="hidden" name="MM_insert" value="form1" />
                    <input type="hidden" name="id_kafedry" value="<?php  echo $row['id_kafedry']; ?>" />
