...
<?php 
    ...
    $result_s = mysqli_query($bd_konferentsii, $query);
    ...
    if ( (isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
        ...
        $query = "INSERT INTO `konferintsii` (`id_spivrobitnyka`, `nazva_konferentsii`, `data_pochatku`, `data_zakinchena`) VALUES ('$id_spivrobitnyka', '$nazva_konferentsii', '$data_pochatku', '$data_zakinchena')";
    ...
    <div class="container-fluid" style="min-height: 50vh">
        <div class="row"> 
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-center mx-auto"> 
                <h2 class="text-primary">Конференсії <br> (новий запис) </h2>
                <form method="post" name="from1"> 
                    <div class="form-group"> 
                        <label for="id_spivrobitnyka">Відповідальний</label>
                        <input 
                            list="id"
                            class="form-control" 
                        ...
                        <datalist id="id"> 
                            ...
                            ?>
                            <option value="<?php echo $row["id_spivrobitnyka"]; ?>"><?php echo $row["prizvyshche"]; ?></option>
                            <?php 
                                } 
                            ?>
                        </datalist>
                    ...
                    <div class="form-group"> 
                        <label for="nazva_konferentsii">Вкажіть назву</label>
                        <input type="text" class="form-control" name="nazva_konferentsii" placeholder="Ведіть назву">
                    </div>
                    <div class="form-group"> 
                        <label for="data_pochatku">Дата початку</label>
                        <input type="date" class="form-control" name="data_pochatku" placeholder="дд.мм.гггг">
                    </div>
                    <div class="form-group"> 
                        <label for="data_zakinchena">Дата закінчення</label>
                        <input type="date" class="form-control" name="data_zakinchena" placeholder="дд.мм.гггг">
                    </div>
