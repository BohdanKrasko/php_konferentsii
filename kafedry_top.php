...
<?php 
    ...
    $query = "SELECT
        ...
        COUNT(konferintsii.id_konferentsii) as kilkist
    FROM
        kafedry
    LEFT JOIN
        spivrobitnuky ON spivrobitnuky.id_kafedry = kafedry.id_kafedry
    LEFT JOIN
        konferintsii ON konferintsii.id_spivrobitnyka = spivrobitnuky.id_spivrobitnyka
    GROUP BY
        kafedry.nazva_kafedry,
        kafedry.roztashuvannya
    ORDER BY
    ...
    <table width="100%" border="1"> 
        <tbody> 
            <tr style="front-weight: 600;"> 
                ...
                <td>Назва кафедри</td>
                <td align="center">Розташування</td>
                <td align="center">Кількість проведених конференсій</td>
            </tr>
            <?php 
                if (isset($result)) {
                    $i=1;
            ...
            <tr> 
                ...
                <td align="center"><?php echo $row["roztashuvannya"]; ?></td>
