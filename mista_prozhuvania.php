    ...
    <div class="container-fluid" style="min-height: 50vh">
        <div class="row"> 
            <div class="col-12 text-center"> 
                <h1 class="text-primary">Місця проживання</h1>
                <div class="text-right"> 
                    <a href="mista_prozhuvania_add.php" class="btn btn-primary btn-sm my-2">Додати запис</a>
                </div>
                <div class="table-responsive"> 
                    <table class="table table-hover table-bordered"> 
                        <tbody> 
                            ...
                            <tr class="text-dark"> 
                                <td>
                                    <a href="mista_prozhuvania_del.php?id_misca_progyvana=<?php echo $row['id_misca_progyvana'];?>" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Видалити" onclick="return confirm('Ви впевнені, що хочете видалити запис?')"></a>
                                </td>
                                <td>
                                    <a href="mista_prozhuvania_edit.php?id_misca_progyvana=<?php echo $row['id_misca_progyvana'];?>" class="btn btn-warning btn-sm" data-toggle="tooltip" title="Редагувати"></a>
                                </td>
